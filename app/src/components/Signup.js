const Signup = ({ setGoToLogInForm }) => {
    ...
    return (
        <div className='d-flex flex-column justify-content-center align-items-center'>
            <form className='bg-white rounded border d-flex flex-column justify-content-center p-4' style={formStyling}>
                ...
                <div className='d-grid px-2 mb-2'>
                    ...
                    <input name="username" className='py-2 px-3 rounded login-input-field' style={inputStyling} placeholder="Enter username" required></input>
                </div>
                <div className='d-grid px-2 mb-2'>
                    <label htmlFor="fullname" className='mb-2'><strong>Full Name</strong></label>
                    <input name="fullname" className='py-2 px-3 rounded login-input-field' style={inputStyling} placeholder="Enter full name" required></input>
                </div>
                <div className='d-grid px-2 mb-2'>
                    <label htmlFor="email" className='mb-2'><strong>Email</strong></label>
                    <input name="email" className='py-2 px-3 rounded login-input-field' style={inputStyling} placeholder="Enter email address" required></input>
                </div>
                <div className="d-flex px-2 mb-2 w-100">
                    <div className='d-flex flex-column me-2 w-50'>
                        ...
                        <input name="signup-password" className='py-2 px-3 rounded login-input-field' style={inputStyling} placeholder="Enter password" required></input>
                    </div>
                    <div className='d-flex flex-column w-50'>
                        <label htmlFor="password-confirm" className='mb-2'><strong>Confirm Password</strong></label>
                        <input name="password-confirm" className='py-2 px-3 rounded login-input-field' style={inputStyling} placeholder="Confirm password" required></input>
                    </div>
                </div>
                ...
                <div className='d-flex justify-content-center px-1 mb-2'>
                    <span onClick={setGoToLogInForm} className='text-decoration-none'
