        ...
        <div className="h-100 message-thread" id={`message-thread-${friendChatData.friend}`} name={`message-thread-for-${friendChatData.friend}`}>
            ...
            <div className="d-flex justify-content-center align-items-center px-3 w-100" style={messageInputSection}>
                <div className="d-flex flex-column col-11">
                    <input className="p-2 user-select-none message-input-bar" style={messageInputBar} type='text' placeholder={`Message @${friendChatData.friend}`} value={messageBuffer} onInput={captureFriendMessageInput} onKeyUp={checkForSubmitKey}/>
                ...
                <button 
                    ...
                    onClick={messageBuffer.length <= 500  ? submitMessage : null}>
...
const ChatMessage = ({ messageObj }) => {
    ...
    return (
        <div className="d-flex align-items-center user-select-none w-100 mw-100 my-1 p-2 shadow chat-message" style={chatMessage} name={`message-id-${messageObj.message_id}`}>
